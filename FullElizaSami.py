...
while asking:
	...
	print("'" + answer + "'")
	answer = input("ELIZA: Please tell me more about it?: ")
        #answer = input("ELIZA: Please tell me more about it?")
	print("'" + answer + "'")
	answer = input("ELIZA: Many of my patients tell me the same thing: ")
	print("'" + answer + "'")
	answer = input("ELIZA: Good day. It is getting late, maybe we had better quit: ")
	print("'" + answer + "'")

	#modified1 = answer.replace("I","you")
	#modified2 = modified1.replace("me","you")
	#modified3 = modified2.replace("my","your")
	#modified4 = modified3.replace("am","are")
